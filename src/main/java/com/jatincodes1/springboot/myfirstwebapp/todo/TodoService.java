...
public class TodoService {
    ...
    static {  // this will work first .. when class is made
        ...
        todos.add(new Todo(++todosCount,"in28minutes","Get Azure Certified 1",LocalDate.now().plusYears(1),false));
        todos.add(new Todo(++todosCount,"in28minutes","Get GCP Certified 1",LocalDate.now().plusYears(1),false));
    }
    ...
    public void deleteById(int id){
        //todo.getId() == id  // checking for equality
        //todo -> todo.getId() == id
